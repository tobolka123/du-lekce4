...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String jmeno = "Štěpán";
        String prijmeni = "Stefan";
        int datum_narozeni = 1998;
        double pocet_sjednanych_smlouv = 93;
        double prodana_mrkev_v_tunach = 54;
        String SPZ = "5SR_6695";
        double spotreba_v_litrech_na_100km = 23.5;
        String IP = "192.168.48.39.";
        double prodana_mrkev_na_smlouvu = prodana_mrkev_v_tunach / pocet_sjednanych_smlouv;
        System.out.println("Prodaná mrkev na jednu smlouvu: " + prodana_mrkev_na_smlouvu);
    }
}
